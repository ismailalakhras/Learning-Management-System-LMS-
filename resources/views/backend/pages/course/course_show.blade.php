...
@section('content')
    <div class="seller-course">
        ...
        <div class="frame-2">
            <div class="frame-3">
                <p class="text-wrapper-2">Students Of {{ $course->title }} </p>
            ...
            <div class="backend-tabs">
                ...
                <div class="orders-wrapper" style="border-bottom:3px solid #3B82F6;color:#3B82F6;padding-bottom:8px">
                    <div class="orders-2" onclick="window.location='{{ route('admin.course.show', $course->id) }}'" style="cursor: pointer">Students
                    </div>
                </div>


                <div class="orders-wrapper">
                    <div class="orders-2" onclick="window.location='{{ route('admin.course.reviews', $course->id) }}'" style="cursor: pointer">Reviews</div>
                </div>
